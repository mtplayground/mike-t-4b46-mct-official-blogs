...
- Admin area protected by env-configured username/password and a signed HTTP-only cookie session.
...
- Admin auth is a first-party env-credential flow, not Google OAuth or a custom JWT layer.
